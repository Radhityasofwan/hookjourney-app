...
<div class="mb-8 relative z-50 flex flex-col xl:flex-row xl:items-end justify-between gap-6">
    <div>
        <h1 class="text-3xl md:text-4xl font-extrabold text-white tracking-tight drop-">
    ...
    <form action="<?= base_url('dashboard') ?>" method="GET" class="flex flex-wrap items-center gap-2 bg-ios-cardLight dark:bg-ios-cardDark backdrop-blur-3xl shadow-[0_4px_24px_rgba(0,0,0,0.04)] dark:shadow-none active:scale-[0.98] transition-transform duration-200 p-2 rounded-[20px] w-max">
        <div class="flex items-center px-3 py-2 bg-black/20 rounded-xl">
        ...
        <button type="submit" class="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-bold transition-all ml-1">
            Filter Data
        </button>
    </form>
</div>
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6 mb-8 relative z-40">
    ...
    <div class="bg-white/5 backdrop-blur-2xl rounded-[28px] p-6 relative overflow-hidden group hover:-translate-y-1 hover: transition-all duration-300">
        ...
        <div class="mt-4 flex items-center text-[10px] font-medium text-white/40 bg-black/20 w-max px-3 py-1.5 rounded-full">
    ...
    <div class="bg-white/5 backdrop-blur-2xl rounded-[28px] p-6 relative overflow-hidden group hover:-translate-y-1 hover: transition-all duration-300">
        ...
        <div class="mt-4 flex items-center text-xs font-medium text-emerald-300 bg-emerald-500/10 border-emerald-500/20 w-max px-3 py-1.5 rounded-full backdrop-blur-md">
    ...
    <div class="bg-white/5 backdrop-blur-2xl rounded-[28px] p-6 relative overflow-hidden group hover:-translate-y-1 hover: transition-all duration-300">
        ...
        <a href="<?= base_url('content/kanban') ?>" class="mt-4 inline-flex items-center text-[10px] font-medium text-white/60 hover:text-white bg-white/5 w-max px-3 py-1.5 rounded-full backdrop-blur-md transition-colors text-decoration-none">
    ...
    <div class="bg-white/5 backdrop-blur-2xl rounded-[28px] p-6 relative overflow-hidden group hover:-translate-y-1 hover: transition-all duration-300">
        ...
        <div class="mt-4 flex items-center text-xs font-bold text-orange-300 bg-orange-500/10 border-orange-500/20 w-max px-3 py-1.5 rounded-full backdrop-blur-md">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 relative z-40">
    ...
    <div class="lg:col-span-2 bg-white/5 backdrop-blur-2xl rounded-[32px] p-6 md:p-8 flex flex-col overflow-x-auto scrollbar-hide">
        <div class="flex justify-between items-center mb-6 min-w-[500px]">
            ...
            <span class="bg-black/30 text-white/60 text-[10px] uppercase font-bold px-3 py-1 rounded-full">
                Sesuai Filter
            </span>
        </div>
        ...
        <div class="flex-grow flex items-end justify-between gap-1 md:gap-3 h-48 mt-4 min-w-[500px]">
            ...
            <div class="flex flex-col items-center flex-1 group relative">
                <div class="w-full relative flex justify-center items-end bg-black/20 rounded-full h-full p-0.5 md:p-1 hover: transition-colors cursor-crosshair">
                ...
                <div class="absolute -top-12 bg-black/90 backdrop-blur-md text-white text-xs px-3 py-2 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-50 flex flex-col items-center">
    ...
    <div class="lg:col-span-1 bg-white/5 backdrop-blur-2xl rounded-[32px] p-6 md:p-8 flex flex-col h-full">
        ...
        <div class="flex-grow flex flex-col <?= empty($recentActivities) ? 'justify-center items-center text-center py-8' : '' ?>">
            ...
            <?php if(empty($recentActivities)): ?>
                <div class="w-20 h-20 rounded-full bg-white/5 flex items-center justify-center mb-5">
                    <i class="ph-fill ph-ghost text-4xl text-white/30 drop-"></i>
                </div>
            ...
            <?php else: ?>
                <div class="w-full space-y-3">
                    <?php foreach($recentActivities as $act): ?>
                        <div class="flex items-center p-3.5 bg-black/20 hover:bg-white/5 transition-colors rounded-[20px] group">
                            ...
                            <div class="w-10 h-10 rounded-[14px] flex items-center justify-center mr-3.5 shrink-0 <?= $color ?>">
