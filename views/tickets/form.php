...
<div class="mb-6 flex items-center relative z-50">
    <a href="<?= base_url('tickets') ?>" class="flex items-center justify-center w-10 h-10 rounded-full bg-white/5 hover:bg-white/10 text-white/70 hover:text-white transition-all mr-4 text-decoration-none">
...
<form action="<?= base_url($isEdit ? 'tickets/update' : 'tickets/store') ?>" method="POST" class="relative z-40">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-8 space-y-6">
            <div class="bg-ios-cardLight dark:bg-ios-cardDark backdrop-blur-3xl shadow-[0_4px_24px_rgba(0,0,0,0.04)] dark:shadow-none active:scale-[0.98] transition-transform duration-200 p-6 rounded-[28px] h-full">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" value="<?= htmlspecialchars($old['title'] ?? '') ?>" class="w-full px-4 py-3 bg-black/30 <?= isset($errors['title']) ? 'border-red-500/50 focus:ring-red-500/20' : ' focus:ring-white/20' ?> rounded-2xl text-white focus:ring-2 focus: outline-none transition-all text-sm placeholder-white/30" placeholder="Contoh: Desain Banner Promo Akhir Bulan" required>
        ...
        <div class="lg:col-span-4 space-y-6">
            <div class="bg-ios-cardLight dark:bg-ios-cardDark backdrop-blur-3xl shadow-[0_4px_24px_rgba(0,0,0,0.04)] dark:shadow-none active:scale-[0.98] transition-transform duration-200 p-6 rounded-[28px] flex flex-col h-full">
                ...
                <div class="space-y-6 flex-grow">
                    <div>
                        ...
                        <select name="assigned_to" class="w-full px-4 py-3 bg-black/30 rounded-2xl text-white focus:ring-2 focus:ring-white/20 focus: outline-none transition-all text-sm appearance-none cursor-pointer">
                    ...
                    <div>
                        ...
                        <select name="priority" class="w-full px-4 py-3 bg-black/30 rounded-2xl text-white focus:ring-2 focus:ring-white/20 focus: outline-none transition-all text-sm appearance-none cursor-pointer" required>
                    ...
                    <div>
                        ...
                        <select name="category_id" class="w-full px-4 py-3 bg-black/30 rounded-2xl text-white focus:ring-2 focus:ring-white/20 focus: outline-none transition-all text-sm appearance-none cursor-pointer">
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="due_at" value="<?= $old['due_at'] ?? '' ?>" class="w-full px-4 py-3 bg-black/30 rounded-2xl text-white focus:ring-2 focus:ring-white/20 focus: outline-none transition-all text-sm [color-scheme:dark]">
                    </div>
                </div>
