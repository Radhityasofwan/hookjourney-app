...
<div class="grid grid-cols-1 xl:grid-cols-2 gap-8 relative z-40">
    ...
    <!-- ==============================================
         ...
         ============================================== -->
    <div class="space-y-6">
        <div class="bg-ios-cardLight dark:bg-ios-cardDark backdrop-blur-3xl shadow-[0_4px_24px_rgba(0,0,0,0.04)] dark:shadow-none active:scale-[0.98] transition-transform duration-200 p-6 md:p-8 rounded-[28px] h-full flex flex-col">
            <div class="flex items-center justify-between mb-5 border-b pb-4">
                ...
                <span class="px-3 py-1 text-[10px] font-bold rounded-full bg-blue-500/20 text-blue-300 border-blue-500/30 backdrop-blur-md tracking-wider">
            ...
            <div class="space-y-3 mb-6 max-h-[220px] overflow-y-auto pr-2 scrollbar-hide flex-grow">
                <?php if(empty($adAccounts)): ?>
                    <div class="p-8 text-center rounded-[20px] bg-white/5 text-white/40">
                ...
                <?php else: ?>
                    <?php foreach($adAccounts as $acc): ?>
                        <div class="flex items-center justify-between p-4 bg-black/20 hover:bg-white/5 transition-colors rounded-[20px] group">
                            <div>
                                <p class="text-sm font-semibold text-white/90 flex items-center group-hover:text-white transition-colors">
                                    <i class="ph-fill ph-meta-logo text-blue-400 mr-2 text-lg drop-"></i> <?= htmlspecialchars($acc['account_name']) ?>
                                </p>
                            ...
                            <span class="text-[9px] uppercase font-bold text-white/60 bg-white/10 px-2.5 py-1 rounded-full backdrop-blur-md">
                                <?= $acc['currency'] ?>
                            </span>
                        </div>
                    <?php endforeach; ?>
            ...
            <form action="<?= base_url('brand/ad-account/store') ?>" method="POST" class="bg-black/20 p-5 rounded-[24px] mt-auto">
                ...
                <div class="space-y-3 mb-4">
                    <input type="text" name="account_name" placeholder="Nama Akun Iklan *" class="w-full px-4 py-3 bg-white/5 rounded-2xl text-white focus:ring-2 focus:ring-white/20 focus: outline-none transition-all text-sm placeholder-white/30" required>
                    <input type="text" name="account_id_external" placeholder="Meta Account ID (Opsional)" class="w-full px-4 py-3 bg-white/5 rounded-2xl text-white focus:ring-2 focus:ring-white/20 focus: outline-none transition-all text-sm placeholder-white/30 font-mono">
                    <select name="currency" class="w-full px-4 py-3 bg-white/5 rounded-2xl text-white focus:ring-2 focus:ring-white/20 focus: outline-none transition-all text-sm appearance-none cursor-pointer">
    ...
    <div class="space-y-6">
        <div class="bg-ios-cardLight dark:bg-ios-cardDark backdrop-blur-3xl shadow-[0_4px_24px_rgba(0,0,0,0.04)] dark:shadow-none active:scale-[0.98] transition-transform duration-200 p-6 md:p-8 rounded-[28px] h-full flex flex-col">
            <div class="flex items-center justify-between mb-5 border-b pb-4">
                ...
                <span class="px-3 py-1 text-[10px] font-bold rounded-full bg-purple-500/20 text-purple-300 border-purple-500/30 backdrop-blur-md tracking-wider">
                    <?= count($pillars) ?> Pilar
                </span>
            </div>
            ...
            <div class="space-y-3 mb-6 max-h-[220px] overflow-y-auto pr-2 scrollbar-hide flex-grow">
                ...
                <?php else: ?>
                    <?php foreach($pillars as $p): ?>
                        <div class="p-4 bg-black/20 hover:bg-white/5 transition-colors rounded-[20px] group">
                            <p class="text-sm font-semibold text-white/90 flex items-center group-hover:text-white transition-colors">
            ...
            <form action="<?= base_url('brand/pillar/store') ?>" method="POST" class="bg-black/20 p-5 rounded-[24px] mt-auto">
                <p class="text-xs font-semibold text-white/50 uppercase tracking-wider mb-4 flex items-center">
                    <i class="ph-bold ph-plus-circle mr-1.5"></i> Tambah Pilar Baru
                </p>
                <div class="space-y-3 mb-4">
                    <input type="text" name="name" placeholder="Nama Pilar (Contoh: Edukasi) *" class="w-full px-4 py-3 bg-white/5 rounded-2xl text-white focus:ring-2 focus:ring-white/20 focus: outline-none transition-all text-sm placeholder-white/30" required>
                    <textarea name="description" rows="2" placeholder="Deskripsi singkat (Opsional)" class="w-full px-4 py-3 bg-white/5 rounded-2xl text-white focus:ring-2 focus:ring-white/20 focus: outline-none transition-all text-sm placeholder-white/30 resize-none"></textarea>
                </div>
                <button type="submit" class="w-full py-3 flex items-center justify-center bg-white text-black rounded-full shadow-[0_0_20px_rgba(255,255,255,0.2)] text-sm font-bold hover:scale-105 active:scale-95 transition-all">
                    Simpan Pilar
                </button>
    ...
    <div class="space-y-6">
        <div class="bg-ios-cardLight dark:bg-ios-cardDark backdrop-blur-3xl shadow-[0_4px_24px_rgba(0,0,0,0.04)] dark:shadow-none active:scale-[0.98] transition-transform duration-200 p-6 md:p-8 rounded-[28px] h-full flex flex-col">
            <div class="flex items-center justify-between mb-5 border-b pb-4">
                ...
                <span class="px-3 py-1 text-[10px] font-bold rounded-full bg-emerald-500/20 text-emerald-300 border-emerald-500/30 backdrop-blur-md tracking-wider">
            ...
            <div class="space-y-3 mb-6 max-h-[220px] overflow-y-auto pr-2 scrollbar-hide flex-grow">
                ...
                <?php else: ?>
                    <?php foreach($ticketCategories as $tc): ?>
                        <div class="p-4 bg-black/20 hover:bg-white/5 transition-colors rounded-[20px] flex items-center group">
                            <div class="w-3 h-3 rounded-full mr-3" style="background-color: <?= htmlspecialchars($tc['color_hex'] ?: '#3b82f6') ?>;"></div>
            ...
            <form action="<?= base_url('brand/ticket-category/store') ?>" method="POST" class="bg-black/20 p-5 rounded-[24px] mt-auto">
                <p class="text-xs font-semibold text-white/50 uppercase tracking-wider mb-4 flex items-center">
                    <i class="ph-bold ph-plus-circle mr-1.5"></i> Tambah Kategori
                </p>
                
                <div class="flex items-center bg-white/5 rounded-2xl p-2 focus-within:ring-2 focus-within:ring-white/20 transition-all mb-4">
    ...
    <div class="space-y-6">
        <div class="bg-ios-cardLight dark:bg-ios-cardDark backdrop-blur-3xl shadow-[0_4px_24px_rgba(0,0,0,0.04)] dark:shadow-none active:scale-[0.98] transition-transform duration-200 p-6 md:p-8 rounded-[28px] h-full flex flex-col">
            <div class="flex items-center justify-between mb-5 border-b pb-4">
                ...
                <span class="px-3 py-1 text-[10px] font-bold rounded-full bg-orange-500/20 text-orange-300 border-orange-500/30 backdrop-blur-md tracking-wider">
            ...
            <form action="<?= base_url('brand/forum-category/store') ?>" method="POST" class="bg-black/20 p-5 rounded-[24px] mt-auto">
                <p class="text-xs font-semibold text-white/50 uppercase tracking-wider mb-4 flex items-center">
                    <i class="ph-bold ph-plus-circle mr-1.5"></i> Tambah Kategori
                </p>
                <div class="space-y-3 mb-4">
                    <input type="text" name="name" placeholder="Nama Kategori (Contoh: Pengumuman) *" class="w-full px-4 py-3 bg-white/5 rounded-2xl text-white focus:ring-2 focus:ring-white/20 focus: outline-none transition-all text-sm placeholder-white/30" required>
                    <textarea name="description" rows="2" placeholder="Deskripsi singkat (Opsional)" class="w-full px-4 py-3 bg-white/5 rounded-2xl text-white focus:ring-2 focus:ring-white/20 focus: outline-none transition-all text-sm placeholder-white/30 resize-none"></textarea>
                </div>
                <button type="submit" class="w-full py-3 flex items-center justify-center bg-white text-black rounded-full shadow-[0_0_20px_rgba(255,255,255,0.2)] text-sm font-bold hover:scale-105 active:scale-95 transition-all">
