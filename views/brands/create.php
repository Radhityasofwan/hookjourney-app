<div class="mb-6 flex items-center relative z-50">
    <a href="<?= base_url('dashboard') ?>" class="flex items-center justify-center w-10 h-10 rounded-full bg-white/5 hover:bg-white/10 text-white/70 hover:text-white transition-all mr-4 text-decoration-none">
...
<div class="grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-40">
    ...
    <div class="lg:col-span-7">
        <div class="bg-ios-cardLight dark:bg-ios-cardDark backdrop-blur-3xl shadow-[0_4px_24px_rgba(0,0,0,0.04)] dark:shadow-none active:scale-[0.98] transition-transform duration-200 p-6 md:p-8 rounded-[28px]">
            ...
            <form action="<?= base_url('brand/store') ?>" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" class="w-full px-4 py-3 bg-black/30 rounded-2xl text-white focus:ring-2 focus:ring-white/20 focus: outline-none transition-all text-sm placeholder-white/30" placeholder="Contoh: Skincare Beauty Glow" required>
                </div>

                <div>
                    <label class="block text-xs font-semibold text-white/60 mb-2 uppercase tracking-wide">Kategori Industri</label>
                    <input type="text" name="industry" class="w-full px-4 py-3 bg-black/30 rounded-2xl text-white focus:ring-2 focus:ring-white/20 focus: outline-none transition-all text-sm placeholder-white/30" placeholder="Contoh: F&B, Fashion, Klinik Kecantikan">
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-xs font-semibold text-white/60 mb-2 uppercase tracking-wide">Mata Uang (Ads)</label>
                        <select name="currency" class="w-full px-4 py-3 bg-black/30 rounded-2xl text-white focus:ring-2 focus:ring-white/20 focus: outline-none transition-all text-sm appearance-none cursor-pointer">
                    ...
                    <div>
                        ...
                        <select name="timezone" class="w-full px-4 py-3 bg-black/30 rounded-2xl text-white focus:ring-2 focus:ring-white/20 focus: outline-none transition-all text-sm appearance-none cursor-pointer">
    ...
    <div class="lg:col-span-5 hidden lg:flex">
        <div class="w-full h-full p-10 flex flex-col justify-center items-center text-center bg-ios-cardLight dark:bg-ios-cardDark backdrop-blur-3xl shadow-[0_4px_24px_rgba(0,0,0,0.04)] dark:shadow-none active:scale-[0.98] transition-transform duration-200 rounded-[28px] relative overflow-hidden group">
            ...
            <i class="ph-fill ph-rocket text-8xl text-white/20 mb-6 drop- group-hover:text-white/40 group-hover:-translate-y-2 transition-all duration-500 relative z-10"></i>
