<div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between relative z-50">
    <div>
        ...
        <p class="text-white/60 text-sm mt-1">Kolaborasi dan berbagi insight untuk <strong
    ...
    <div class="lg:col-span-4">
        <div class="bg-ios-cardLight dark:bg-ios-cardDark backdrop-blur-3xl shadow-[0_4px_24px_rgba(0,0,0,0.04)] dark:shadow-none active:scale-[0.98] transition-transform duration-200 p-6 rounded-[28px] sticky top-6">
            ...
            <form action="<?= base_url('forum/store') ?>" method="POST" class="space-y-5">
                ...
                <div class="pt-2">
                    <button type="submit"
                        class="w-full py-3.5 flex items-center justify-center bg-white text-black rounded-full shadow-[0_0_20px_rgba(255,255,255,0.2)] text-sm font-bold hover:scale-105 active:scale-95 transition-all">
